...
server_configs = [1317658154397466715]  # Reemplaza con tu ID o lista de IDs
ticket_category_id = 1317725865584365688  # Reemplaza con el ID de la categoría para tickets
vouch_channel_id = 1317725063893614633  # Reemplaza con el ID del canal para vouches
